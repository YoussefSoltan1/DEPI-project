...
import { FilterParams, Movie } from '@shared/types';
...
const MoviesPage = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['/api/discover/movies', filters],
    ...
    return (
      <div className="min-h-screen bg-primary">
        ...
        <div className="container mx-auto py-10 px-4 text-center">
          <h2 className="text-2xl font-semibold text-white mb-4">Error Loading Movies</h2>
    ...
    <div className="min-h-screen bg-primary">
      ...
      <div className="bg-hoverBg py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-textSecondary mt-2">Browse our collection of movies</p>
        </div>
      </div>
